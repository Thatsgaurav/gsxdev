    ...
    useEffect(() => {
        let ctx = gsap.context(() => {
            ...
            window.onmousemove = (e) => {
                ...
                const componentRectCenterX = componentRect.left + componentRect.width / 2;

                let componentPercent = {
                    x: (e.clientX - componentRectCenterX) / componentRect.width / 2,
                }
        ...
        <div ref={component} className={clsx("relative h-full w-full", className)}>
            <div className="avatar aspect-square overflow-hidden rounded-3xl border-2 border-slate-700 opacity-0f">
                <PrismicNextImage
                    ...
                    imgixParams={{ q: 90 }}
                />
                <div className="heighlight absolute inset-0 hidden w-full scale-110 bg-radinet-to-tr from-transparent
